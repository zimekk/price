...
const Offer = z.object({
  ...
  main_image: z.object({
    ...
    m_img_224x147: z.string(),
    m_img_277x160: z.string(),
    m_img_336x160: z.string(),
    m_img_350x230: z.string(),
    m_img_350x648: z.string(),
    m_img_375x211: z.string(),
    m_img_440x248: z.string(),
    m_img_440x440: z.string(),
    m_img_500: z.string(),
    m_img_728x728: z.string(),
    m_img_750: z.string(),
    m_img_760x428: z.string(),
    m_img_983x552: z.string(),
    m_img_1160x653: z.string(),
    m_img_1500: z.string(),
  }),
  name: z.string(),
...
const SelectedRegion = z.object({
  ...
  stats: z.object({
    ...
    properties_all_rooms_ranges: z.record(z.number()),
    properties_commercials_count_cheap: z.number(),
    properties_commercials_rooms_ranges: z.record(z.number()),
    ...
    properties_flats_rooms_ranges: z.record(z.number()),
    ...
    properties_houses_rooms_ranges: z.record(z.number()),
    region_type_city: z
      .object({
        id: z.number(),
        slug: z.string(),
...
const JsonSchema = z.object({
  ...
  offersNearby: z.object({
    ...
    offerList: z.array(z.unknown()),
    offerListRequestState: z.number(),
    offerDetail: z.array(z.unknown()),
    offerDetailRequestState: z.number(),
    propertyDetail: z.array(z.unknown()),
    propertyDetailRequestState: z.number(),
  }),
  ourOffer: z.object({
  ...
  property: z.object({
    ...
    offersNearbyCount: z.null(),
    offersNearbyRequest: z.number(),
    relatedOffers: z.array(z.unknown()),
    relatedOffersRequestState: z.number(),
    nearbyRegions: z.array(z.unknown()),
    nearbyRegionsRequestState: z.number(),
