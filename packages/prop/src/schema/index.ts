...
const Ad = z.object({
  ...
  investmentState: z.string().nullable(),
  ...
  investmentUnitsNumber: z.number().nullable(),
  priceFromPerSquareMeter: z.null(),
  terrainAreaInSquareMeters: z.number().nullable(),
  investmentUnitsRoomsNumber: z.looseObject({}).nullable(),
  investmentEstimatedDelivery: z.looseObject({}).nullable(),
  investmentUnitsAreaInSquareMeters: z.looseObject({}).nullable(),
});
